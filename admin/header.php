...
<head>
    ...
    <meta charset="utf-8" />
    <title>Dashboard | Rapidbill Billing Software</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Rapidbill Premium & Multipurpose Billing Software" name="description" />
    <meta content="Rapidbill" name="author" />
    <!-- App favicon -->
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="purchase-entry.php">
                                <i class="ri-add-circle-line"></i> <span data-key="t-purchase">Purchase Entry</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="sales-entry.php">
                                <i class="ri-shopping-cart-2-line"></i> <span data-key="t-sales">Sales Entry</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="purchase-entries.php">
                                <i class="ri-pages-line"></i> <span data-key="t-purchases">Purchase Entries</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="sales-entries.php">
                                <i class="ri-pages-line"></i> <span data-key="t-saless">Sales Entries</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="manage-stock.php">
                                <i class="ri-store-2-line"></i> <span data-key="t-managestock">Manage Stock</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="khatabook.php">
                                <i class="ri-currency-line"></i> <span data-key="t-khatabook">Khatabook</span>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="reset-password.php">
