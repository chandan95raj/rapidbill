            ...
            <div class="col-lg-8 col-sm-10">
                <div class="text-center mt-lg-5 pt-5">
                    <h1 class="display-6 fw-semibold mb-3 lh-base">The better way to manage your website with <span
                            class="text-primary">Rapidbill </span></h1>
                    <p class="lead text-muted lh-base">Rapidbill is a multipurpose and premium Billing Software
                        </p>

                    <div class="d-flex gap-2 justify-content-center mt-4">
                        <a href="signin.php" class="btn btn-primary">Get Started <i
...
<section class="py-5 bg-primary position-relative">
    ...
    <div class="container">
        <div class="row align-items-center gy-4">
            <div class="col-sm">
                <div>
                    <h4 class="text-white mb-0 fw-semibold">Build your web App/SaaS with Rapidbill dashboard</h4>
                </div>
            </div>
            <!-- end col -->
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0 me-2">
                                        <div class="avatar-xs icon-effect">
                                            <div class="avatar-title bg-transparent text-primary rounded-circle h2">
        ...
        <div class="row align-items-center mt-5 pt-lg-5 gy-4">
            ...
            <div class="col-lg-6">
                <div class="text-muted ps-lg-5">
                    ...
                    <p class="mb-4">used to describe something that is known about or known to be true because there are
                        many documents that describe it, prove it, etc.</p>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="text-center">
                    <div>
                        <i class="ri-double-quotes-l text-primary display-3"></i>
                    </div>
                    <h4 class="text-white mb-5"><span class="text-primary">19k</span>+ Satisfied clients</h4>
